package com.example.foodappsever.ui.best_deals;
...
import com.example.foodappsever.adapter.MyBestDealsAdapter;
...
public class BestDealsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mViewModel= new ViewModelProvider(this).get(BestDealsViewModel.class);
